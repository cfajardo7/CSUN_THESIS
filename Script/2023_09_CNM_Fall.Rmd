...
cnm_sessile_sum_plot <- cnm_sessile %>%
  ...
  mutate(percent_animal = (A_elegantissima+ Chthalmus_sp+ P_polymerus)/spec_sum*100,
         percent_algae = (Ralfsia_sp+Ulva_sp)/spec_sum*100)
...
#########MIGHT GO WITH THIS ONE############### Doesn't work
...
#####LMER#####
model3_mob_abun <- lmer(spec_sum~COL_pres+(1|Transect), data = cnm_mobiles_sum_spec)
...
model5_sess_an_abun <- lmer(percent_animal~COL_pres+(1|Transect), data = #lmer of animals 
                              cnm_sessile_sum_plot)
anova(model5_sess_an_abun)
summary(model5_sess_an_abun)

model6_sess_al_abun <- lmer(percent_algae~COL_pres+(1|Transect), data = #lmer of algae
                              cnm_sessile_sum_plot)
...
#lmer
model4_mob_rich <- lmer(spec_sum~COL_pres+(1|Transect), data = cnm_mob_count_mat_sum)
...
model5_sess_rich <- lmer(percent_animal~COL_pres+(1|Transect), data = cnm_sessile_sum_plot)
anova(model4_mob_rich)
summary(model4_mob_rich)
```
