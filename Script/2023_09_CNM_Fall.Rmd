...
model5_sess_an_abun <- lmer(percent_animal~COL_pres+(1|Transect), data = cnm_sessile_sum_plot)
anova(model5_sess_an_abun)
summary(model5_sess_an_abun)

model6_sess_al_abun <- lmer(percent_algae~COL_pres+(1|Transect), data = cnm_sessile_sum_plot)
